...
namespace UnityRemoteControl.Middleware
{
    public static class FileDownloaderExtensions
    {
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseFileDownloader(this IApplicationBuilder builder, IWebHostEnvironment env, string folder)
        {
    ...
    {
        public FileDownloaderMiddleware(RequestDelegate next, IWebHostEnvironment hostingEnv) => (Next, HostingEnv) = (next, hostingEnv);
